...
public class NetworkS11n {
    ...
    static {
        ...
        { // Float
            NetS11nAdaptor<Float> adp = new NetS11nAdaptor<Float>() {
                @Override
                public void write(FriendlyByteBuf buf, Float obj) {
                    buf.writeFloat(obj);
                }
        ...
        { // Double
            NetS11nAdaptor<Double> adp = new NetS11nAdaptor<Double>() {
                @Override
                public void write(FriendlyByteBuf buf, Double obj) {
                    buf.writeDouble(obj);
                }
        ...
        { // Boolean
            NetS11nAdaptor<Boolean> adp = new NetS11nAdaptor<Boolean>() {
                @Override
                public void write(FriendlyByteBuf buf, Boolean obj) {
                    buf.writeBoolean(obj);
                }

                @Override
                public Boolean read(FriendlyByteBuf buf) throws ContextException {
        ...
        addDirect(String.class, new NetS11nAdaptor<String>() {
            @Override
            public void write(FriendlyByteBuf buf, String obj) {
        ...
        addDirect(ByteBuf.class, new NetS11nAdaptor<ByteBuf>() {
            @Override
            public void write(FriendlyByteBuf buf, ByteBuf obj) {
                buf.capacity(buf.capacity() + Math.max(obj.readableBytes() - buf.writableBytes(), 0));
                obj.readBytes(buf, obj.readableBytes());
            }

            @Override
            public ByteBuf read(FriendlyByteBuf buf) throws ContextException {
                FriendlyByteBuf buf_ = buf.duplicate();
                FriendlyByteBuf buf2 = Unpooled.buffer(buf_.readableBytes());
        ...
        addDirect(Class.class, new NetS11nAdaptor<Class>() {
            @Override
            public void write(FriendlyByteBuf buf, Class obj) {
            ...
            @Override
            public Class read(FriendlyByteBuf buf) throws ContextException {
        ...
        addDirect(List.class, new NetS11nAdaptor<List>() {
            @Override
            public void write(FriendlyByteBuf buf, List obj) {
            ...
            @Override
            public List read(FriendlyByteBuf buf) {
        ...
        addDirect(Map.class, new NetS11nAdaptor<Map>() {
            @Override
            public void write(FriendlyByteBuf buf, Map obj) {
                _check(obj.size() <= Byte.MAX_VALUE, "Too many objects to serialize");
            ...
            @Override
            public Map read(FriendlyByteBuf buf) {
        ...
        addDirect(Set.class, new NetS11nAdaptor<Set>() {
            @Override
            public void write(FriendlyByteBuf buf, Set obj) {
            ...
            @Override
            public Set read(FriendlyByteBuf buf) throws ContextException {
        ...
        addDirect(BitSet.class, new NetS11nAdaptor<BitSet>() {
            @Override
            public void write(FriendlyByteBuf buf, BitSet obj) {
        ...
        // MC types
        addDirect(CompoundTag.class, new NetS11nAdaptor<CompoundTag>() {
            @Override
            public void write(FriendlyByteBuf buf, CompoundTag obj) {
                buf.writeNbt(obj);
            }
        ...
        addDirect(Entity.class, new NetS11nAdaptor<Entity>() {
            @Override
            public void write(FriendlyByteBuf buf, Entity obj) {
                buf.writeUtf(obj.level().dimension().registry().toString());
        ...
        addDirect(World.class, new NetS11nAdaptor<World>() {
            @Override
            public void write(FriendlyByteBuf buf, World obj) {
                buf.writeShort(obj.provider.getDimension());
            }

            @Override
            public World read(FriendlyByteBuf buf) throws ContextException {
                World wrld = SideUtils.getWorld(buf.readShort());
                if (wrld == null) {
                    throw new ContextException("invalid world");
                } else {
        ...
        addDirect(TileEntity.class, new NetS11nAdaptor<TileEntity>() {
            @Override
            public void write(FriendlyByteBuf buf, TileEntity obj) {
            ...
            @Override
            public TileEntity read(FriendlyByteBuf buf) throws ContextException {
        ...
        addDirect(Vec3d.class, new NetS11nAdaptor<Vec3d>() {
            @Override
            public void write(FriendlyByteBuf buf, Vec3d obj) {
            ...
            @Override
            public Vec3d read(FriendlyByteBuf buf) throws ContextException {
                return new Vec3d(buf.readDouble(), buf.readDouble(), buf.readDouble());
            }
        });
        addDirect(ItemStack.class, new NetS11nAdaptor<ItemStack>() {
            @Override
            public void write(FriendlyByteBuf buf, ItemStack obj) {
            ...
            @Override
            public ItemStack read(FriendlyByteBuf buf) throws ContextException {
    ...
    public static <T> void addDirectInstance(T instance) {
        ...
        addDirect((Class<T>) instance.getClass(), new NetS11nAdaptor<T>() {
            ...
            @Override
            public T read(FriendlyByteBuf buf) throws ContextException {
                return instance;
            }
        });
    }
...
//        Debug.log("SerializeWithHint " + obj.getClass() + "/" + buf.readableBytes());
    ...
    public static <T> void serializeRecursively(FriendlyByteBuf buf, T obj, Class<? super T> type) {
     ...
     * @throws RuntimeException if deserialization failed non-trivially.
     */
    public static <T, U extends T> T deserializeWithHint(FriendlyByteBuf buf, Class<U> type) {
//        Debug.log("DeserializeWithHint " + type + "/" + buf.writerIndex());
    ...
    public static <T, U extends T> T deserializeRecursively(FriendlyByteBuf buf, Class<U> type) {
        try {
    ...
    public static <T, U extends T> void deserializeRecursivelyInto(FriendlyByteBuf buf, T instance, Class<U> type) {
    ...
    public interface NetS11nAdaptor<T> {
         ...
         */
        T read(FriendlyByteBuf buf) throws ContextException;
