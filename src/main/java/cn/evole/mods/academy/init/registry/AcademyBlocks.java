...
import cn.evole.mods.academy.common.block.dev.DevAdvanced;
import cn.evole.mods.academy.common.block.dev.DevAdvancedSubBlock;
import cn.evole.mods.academy.common.block.dev.DevNormal;
import cn.evole.mods.academy.common.block.dev.DevNormalSubBlock;
import cn.evole.mods.academy.common.block.gen.*;
import cn.evole.mods.academy.common.block.node.Matrix;
import cn.evole.mods.academy.common.block.node.MatrixSubBlock;
import cn.evole.mods.academy.common.block.node.NodeBlock;
import cn.evole.mods.academy.common.block.ore.CrystalOre;
import cn.evole.mods.academy.common.block.ore.ImagsilOre;
import cn.evole.mods.academy.common.block.ore.PhaseFluidBlock;
import cn.evole.mods.academy.common.block.ore.ResoOre;
import cn.evole.mods.academy.common.block.resource.ConstraintMetal;
import cn.evole.mods.academy.common.block.resource.ImagFusor;
import cn.evole.mods.academy.common.block.resource.MachineFrame;
import cn.evole.mods.academy.common.block.resource.MetalFomer;
...
public class AcademyBlocks {
    ...
    public static RegistryObject<Block> NODE_BASIC = itemBlock("node_basic", NodeBlock::new);
    public static RegistryObject<Block> NODE_ADVANCED = itemBlock("node_advanced", NodeBlock::new);
    public static RegistryObject<Block> NODE_STANDARD = itemBlock("node_standard", NodeBlock::new);
