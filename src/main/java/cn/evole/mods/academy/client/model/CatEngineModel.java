package cn.evole.mods.academy.client.model;
...
public class CatEngineModel extends Model {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Static.MOD_ID, "cat_engine"), "main");
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
