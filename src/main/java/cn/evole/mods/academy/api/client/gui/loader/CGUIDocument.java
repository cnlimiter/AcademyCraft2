package cn.evole.mods.academy.api.client.gui.loader;

import cn.evole.mods.academy.api.client.gui.Widget;
import cn.evole.mods.academy.api.client.gui.WidgetContainer;
...
public enum CGUIDocument {
    ...
    public static WidgetContainer read(ResourceLocation location) {
        return read(Resources.getResourceStream(location));
    }
