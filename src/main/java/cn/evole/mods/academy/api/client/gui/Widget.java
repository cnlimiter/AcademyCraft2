...
import cn.evole.mods.academy.api.client.gui.component.Component;
...
import cn.evole.mods.academy.api.client.gui.event.GuiEventBus;
...
/**
 * Name: AcademyCraft2 / Widget
 * Author: cnlimiter
 * CreateTime: 2023/12/24 13:32
 * Description:
 */
...
public class Widget extends WidgetContainer {
    ...
    public  Widget walign(Transform.WidthAlign align) {
        transform.alignWidth = align;
        return this;
    }

    public Widget halign(Transform.HeightAlign align) {
